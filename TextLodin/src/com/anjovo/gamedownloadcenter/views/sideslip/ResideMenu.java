package com.anjovo.gamedownloadcenter.views.sideslip;
...
public class ResideMenu extends FrameLayout implements View.OnClickListener {
	...
	private void initViews(Context context) {
		...
		View inflate = inflater.inflate(R.layout.residemenu, this);
		ImageView homeIv_residemenu = (ImageView) inflate.findViewById(R.id.homeIv_residemenu);
		ImageView settingIv_residemenu = (ImageView) inflate.findViewById(R.id.settingIv_residemenu);
		Button sign_in_residemenu = (Button) inflate.findViewById(R.id.sign_in_residemenu);
		...
		homeIv_residemenu.setOnClickListener(this);
		settingIv_residemenu.setOnClickListener(this);
		sign_in_residemenu.setOnClickListener(this);
	}
...
//			ivLeftRing.startAnimation(operatingAnim);
//		}
	}
...
//		AnimatorSet scaleDown_shadow = buildScaleDownAnimation(imageViewShadow, mScaleValue + shadowAdjustScaleX, mScaleValue + shadowAdjustScaleY);
	...
	private void setScaleDirection(int direction) {
		...
		float pivotX;
		float pivotY = getScreenHeight() * 0.5f;//控制右侧fragment在右侧什么位置
...
//					ev.setAction(MotionEvent.ACTION_CANCEL);
	...
	public interface OnMenuListener {
		 ...
		 * animation.
		 */
		public void openMenu(Boolean isFrist);
	...
	public void onClick(View v) {
		if(onClickChangeListener != null){
			onClickChangeListener.onChangeClick(v);
		}
	}
