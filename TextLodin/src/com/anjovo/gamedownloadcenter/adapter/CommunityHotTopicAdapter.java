...
public class CommunityHotTopicAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			...
			holder.shequ_item_activities_detail=(TextView) convertView.findViewById(R.id.shequ_item_activities_detail);
...
class ViewHolder{
	ImageView actimg;
	TextView  title,intro,time,shequ_item_activities_detail;
}
}
